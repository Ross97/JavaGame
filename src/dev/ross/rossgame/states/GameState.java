...
public class GameState extends State {
	...
	public void render(Graphics g) {
		...
		Text.drawString(g, "Health: " + Integer.toString(handler.getWorld().getEntityManager().getPlayer().getHealth()), handler.getWidth() - 190, 25, Color.WHITE, Assets.font_size28);
	}
